...
SECRET_KEY = 'django-insecure-)l#y%n73vevnc=^50cr4hysm&cd(l^#2uj)yklaejyq-3=*x5u'

DEBUG = False

ALLOWED_HOSTS = ['https://ai-adoptimizationback.onrender.com', '127.0.0.1', 'localhost']
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # No templates directory needed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
